...
@=""
`)]),e("ol",{start:"4"},[e("li",null,"Merge file reg fix"),e("li",null,"Restart Explorer.exe in Task Manager"),e("li",null,[n("Follow this instruction to correct errors that do not show the used space bar: "),e("a",{href:"https://www.partitionwizard.com/partitionmanager/disk-space-usage-bar-missing.html",target:"_blank",rel:"noopener"},"https://www.partitionwizard.com/partitionmanager/disk-space-usage-bar-missing.html")])])],-1),D='Fix "The property for this item is not available window"',x=[{property:"og:title",content:'Fix "The property for this item is not available window"'}],O={__name:"fix-the-property-for-this-item-is-not-available-window",setup(E,{expose:r}){const t={title:'Fix "The property for this item is not available window"',meta:[{property:"og:title",content:'Fix "The property for this item is not available window"'}]};return r({frontmatter:t}),o({title:'Fix "The property for this item is not available window"',meta:[{property:"og:title",content:'Fix "The property for this item is not available window"'}]}),(_,d)=>{const a=l;return S(),i(a,{frontmatter:t},{default:s(()=>[h]),_:1})}}};export{O as default,x as meta,D as title};
